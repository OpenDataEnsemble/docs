    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Database",
          items: ["technical-overview/database/overview", "technical-overview/database/schema"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Formplayer",
          items: ["components/formplayer/overview", "components/formplayer/integration"],
        },
        {
          type: "category",
          label: "Documentation",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Configuration",
          items: ["reference/configuration/server", "reference/configuration/client"],
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Support",
          items: ["community/support/getting-help", "community/support/reporting-issues"],
        },
        {
          type: "category",
          label: "Resources",
          items: ["community/resources/examples", "community/resources/projects"],
        },
      ],
    },
    {
      ...
      items: [
        "For-developers/docusaurus/intro",
        {
          ...
          items: ["For-developers/docusaurus/tutorial-extras/manage-docs-versions"],
        },
      ],
    },
  ],
